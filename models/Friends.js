...
function MakeFriends(friend1, friend2) {
    return con.query(`INSERT into friends(friend1,friend2) VALUES ('${friend1}', '${friend2}')`)
}
function CheckIfFriends(friend1, friend2) {
    return con.query(`SELECT * from friends WHERE friend1 = '${friend1}' AND friend2 = '${friend2}' OR friend1 = '${friend2}' AND friend2 = '${friend1}'`)
}
function CheckFriends(username) {
    return con.query(`SELECT * FROM friends WHERE friend1 = '${username}' OR friend2= '${username}'`);
}
